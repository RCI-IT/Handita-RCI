          ...
          <div className="min-w-full rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] bg-white">
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="w-full p-6 border-b-2 border-b-gray-200">
                <p className="font-thin text-[#282828] text-xl">
                  {steps[step]}
                </p>
              </div>
                        ...
                        <Controller
                          ...
                          rules={{
                            ...
                            minLength: {
                              value: 3,
                              message:
                                "Tempat lahir harus lebih dari 3 karakter",
                            },
                          }}
                        ...
                        <Controller
                          ...
                          rules={{
                            ...
                            minLength: {
                              value: 9,
                              message:
                                "Nomor kontak harus lebih dari 9 karakter",
                            },
                            validate: (value) => {
                            ...
                            {field.value && field.value instanceof File ? (
                              ...
                              <>
                                ...
                                >
                                  ...
                                  typeof employeeData.document.idCard ===
                                    "string"
